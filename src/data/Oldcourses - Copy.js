...
export const BROAD_STRIPES = {
  ...
  nines: {
    Front: [
      { hole: 1, par: 5, hcp: 9, greenDepth: 26, tee: { lat: 28.965519, lon: -81.961210 }, green: { lat: 28.962206, lon: -81.959069 } },
      ...
      { hole: 9, par: 5, hcp: 1, greenDepth: 39, tee: { lat: 28.963740, lon: -81.955827 }, green: { lat: 28.966053, lon: -81.959517 } },
    ],

    Back: [
      { hole: 1, par: 5, hcp: 2, greenDepth: 30, tee: { lat: 28.966931, lon: -81.959241 }, green: { lat: 28.967911, lon: -81.955067 } },
...
export const PALMER_LEGENDS = {
  ...
  nines: {
    CherryHill: [
      { hole: 1, par: 5, hcp: 4, greenDepth: 36, tee: { lat: 28.91073, lon: -81.994388 }, green: { lat: 28.913724, lon: -81.997252 }, overlay: { A: { x: 0.5825, y: 0.8072 }, B: { x: 0.4866, y: 0.3702 }, C: { x: 0.5003, y: 0.0869 } } },
      { hole: 2, par: 4, hcp: 2, greenDepth: 37, tee: { lat: 28.913252, lon: -81.999551 }, green: { lat: 28.912943, lon: -82.002888 }, overlay: { A: { x: 0.4638, y: 0.7414 }, B: { x: 0.3596, y: 0.3575 }, C: { x: 0.5013, y: 0.0869 } } },
      { hole: 3, par: 4, hcp: 5, greenDepth: 36, tee: { lat: 28.913313, lon: -82.003668 }, green: { lat: 28.916094, lon: -82.003446 }, overlay: { A: { x: 0.5024, y: 0.7166 }, B: { x: 0.5029, y: 0.316 }, C: { x: 0.4987, y: 0.0847 } } },
      { hole: 4, par: 4, hcp: 1, greenDepth: 33, tee: { lat: 28.919611, lon: -82.005384 }, green: { lat: 28.919501, lon: -82.008325 }, overlay: { A: { x: 0.4753, y: 0.7117 }, B: { x: 0.4724, y: 0.3377 }, C: { x: 0.5013, y: 0.0901 } } },
      { hole: 5, par: 3, hcp: 7, greenDepth: 31, tee: { lat: 28.919678, lon: -82.009969 }, green: { lat: 28.918738, lon: -82.010008 }, overlay: { A: { x: 0.6808, y: 0.6178 }, B: { x: 0.4982, y: 0.0858 }, C: { x: 0.4987, y: 0.0858 } } },
      { hole: 6, par: 4, hcp: 6, greenDepth: 41, tee: { lat: 28.918542, lon: -82.007861 }, green: { lat: 28.918776, lon: -82.004854 }, overlay: { A: { x: 0.487, y: 0.7348 }, B: { x: 0.3973, y: 0.3394 }, C: { x: 0.4992, y: 0.0814 } } },
      { hole: 7, par: 4, hcp: 9, greenDepth: 33, tee: { lat: 28.919259, lon: -82.003497 }, green: { lat: 28.918685, lon: -82.000894 }, overlay: { A: { x: 0.4724, y: 0.7084 }, B: { x: 0.4666, y: 0.3245 }, C: { x: 0.5003, y: 0.0879 } } },
      { hole: 8, par: 3, hcp: 3, greenDepth: 42, tee: { lat: 28.916863, lon: -82.000565 }, green: { lat: 28.915714, lon: -82.000404 }, overlay: { A: { x: 0.495, y: 0.6732 }, B: { x: 0.5003, y: 0.0879 }, C: { x: 0.4997, y: 0.0879 } } },
      { hole: 9, par: 5, hcp: 8, greenDepth: 38, tee: { lat: 28.91188, lon: -81.998429 }, green: { lat: 28.909256, lon: -81.995445 }, overlay: { A: { x: 0.5024, y: 0.7818 }, B: { x: 0.5166, y: 0.3876 }, C: { x: 0.5008, y: 0.0901 } } },
    ],

    LaurelValley: [
      { hole: 1, par: 4, hcp: 5, greenDepth: 31, tee: { lat: 28.914094, lon: -81.993033 }, green: { lat: 28.911572, lon: -81.993309 }, overlay: { A: { x: 0.5043, y: 0.682 }, B: { x: 0.6631, y: 0.3773 }, C: { x: 0.4992, y: 0.0901 } } },
      { hole: 2, par: 5, hcp: 6, greenDepth: 40, tee: { lat: 28.914904, lon: -81.99415 }, green: { lat: 28.918521, lon: -81.993153 }, overlay: { A: { x: 0.4976, y: 0.7807 }, B: { x: 0.38, y: 0.4168 }, C: { x: 0.4987, y: 0.0901 } } },
      { hole: 3, par: 4, hcp: 1, greenDepth: 42, tee: { lat: 28.919511, lon: -81.993516 }, green: { lat: 28.921602, lon: -81.995307 }, overlay: { A: { x: 0.4754, y: 0.7463 }, B: { x: 0.5622, y: 0.3377 }, C: { x: 0.5008, y: 0.089 } } },
      { hole: 4, par: 5, hcp: 9, greenDepth: 32, tee: { lat: 28.922168, lon: -81.997036 }, green: { lat: 28.924804, lon: -81.999651 }, overlay: { A: { x: 0.4997, y: 0.7416 }, B: { x: 0.5087, y: 0.4115 }, C: { x: 0.5003, y: 0.0858 } } },
      { hole: 5, par: 4, hcp: 3, greenDepth: 30, tee: { lat: 28.925267, lon: -81.998678 }, green: { lat: 28.923342, lon: -81.996906 }, overlay: { A: { x: 0.4982, y: 0.6851 }, B: { x: 0.5055, y: 0.3073 }, C: { x: 0.4992, y: 0.0879 } } },
      { hole: 6, par: 3, hcp: 8, greenDepth: 34, tee: { lat: 28.922992, lon: -81.996014 }, green: { lat: 28.922272, lon: -81.99551 }, overlay: { A: { x: 0.4929, y: 0.5353 }, B: { x: 0.5018, y: 0.0836 }, C: { x: 0.5018, y: 0.0836 } } },
      { hole: 7, par: 4, hcp: 2, greenDepth: 41, tee: { lat: 28.9204, lon: -81.992783 }, green: { lat: 28.919149, lon: -81.990133 }, overlay: { A: { x: 0.5045, y: 0.7166 }, B: { x: 0.5995, y: 0.3542 }, C: { x: 0.4992, y: 0.0901 } } },
      { hole: 8, par: 3, hcp: 7, greenDepth: 37, tee: { lat: 28.918594, lon: -81.9906 }, green: { lat: 28.918395, lon: -81.991761 }, overlay: { A: { x: 0.5055, y: 0.6352 }, B: { x: 0.4997, y: 0.0945 }, C: { x: 0.4992, y: 0.0945 } } },
      { hole: 9, par: 4, hcp: 4, greenDepth: 41, tee: { lat: 28.917349, lon: -81.99269 }, green: { lat: 28.914723, lon: -81.993205 }, overlay: { A: { x: 0.5045, y: 0.7296 }, B: { x: 0.6232, y: 0.4185 }, C: { x: 0.4982, y: 0.089 } } },
    ],

    RileyGrove: [
      { hole: 1, par: 4, hcp: 7, greenDepth: 32, tee: { lat: 28.910095, lon: -81.989156 }, green: { lat: 28.91215, lon: -81.987983 }, overlay: { A: { x: 0.4997, y: 0.6471 }, B: { x: 0.4004, y: 0.3558 }, C: { x: 0.4992, y: 0.0869 } } },
      { hole: 2, par: 4, hcp: 2, greenDepth: 30, tee: { lat: 28.91205, lon: -81.985494 }, green: { lat: 28.914707, lon: -81.984697 }, overlay: { A: { x: 0.5, y: 0.75 }, B: { x: 0.495, y: 0.3398 }, C: { x: 0.4987, y: 0.0901 } } },
      { hole: 3, par: 4, hcp: 9, greenDepth: 32, tee: { lat: 28.917976, lon: -81.98363 }, green: { lat: 28.919317, lon: -81.985533 }, overlay: { A: { x: 0.504, y: 0.6059 }, B: { x: 0.38, y: 0.285 }, C: { x: 0.4992, y: 0.0825 } } },
      { hole: 4, par: 5, hcp: 4, greenDepth: 31, tee: { lat: 28.919516, lon: -81.98411 }, green: { lat: 28.919281, lon: -81.979933 }, overlay: { A: { x: 0.5018, y: 0.7546 }, B: { x: 0.5827, y: 0.4382 }, C: { x: 0.4987, y: 0.0879 } } },
      { hole: 5, par: 4, hcp: 1, greenDepth: 34, tee: { lat: 28.918801, lon: -81.978643 }, green: { lat: 28.919187, lon: -81.975673 }, overlay: { A: { x: 0.4992, y: 0.7155 }, B: { x: 0.4321, y: 0.3081 }, C: { x: 0.4997, y: 0.0858 } } },
      { hole: 6, par: 3, hcp: 8, greenDepth: 33, tee: { lat: 28.919244, lon: -81.974937 }, green: { lat: 28.918398, lon: -81.975213 }, overlay: { A: { x: 0.5066, y: 0.557 }, B: { x: 0.4987, y: 0.089 }, C: { x: 0.4992, y: 0.0879 } } },
      { hole: 7, par: 4, hcp: 3, greenDepth: 30, tee: { lat: 28.915833, lon: -81.976434 }, green: { lat: 28.913682, lon: -81.97516 }, overlay: { A: { x: 0.4982, y: 0.6721 }, B: { x: 0.6954, y: 0.3377 }, C: { x: 0.5008, y: 0.0825 } } },
      { hole: 8, par: 3, hcp: 6, greenDepth: 28, tee: { lat: 28.912375, lon: -81.977066 }, green: { lat: 28.911657, lon: -81.977902 }, overlay: { A: { x: 0.4982, y: 0.6232 }, B: { x: 0.4976, y: 0.0945 }, C: { x: 0.4982, y: 0.0934 } } },
      { hole: 9, par: 5, hcp: 5, greenDepth: 32, tee: { lat: 28.911511, lon: -81.980021 }, green: { lat: 28.909728, lon: -81.983721 }, overlay: { A: { x: 0.504, y: 0.7687 }, B: { x: 0.5883, y: 0.374 }, C: { x: 0.4992, y: 0.0836 } } },
    ],
  },
};
