...
export const PALMER_LEGENDS = {
  ...
  nines: {
    CherryHill: [
      { hole: 1, par: 5, hcp: 4, greenDepth: 36, tee: { lat: 28.91073, lon: -81.994388 }, green: { lat: 28.913724, lon: -81.997252 }, overlay: { A: { x: 0.525, y: 0.7731 }, B: { x: 0.4866, y: 0.3702 }, C: { x: 0.5003, y: 0.0869 } } },
      { hole: 2, par: 4, hcp: 2, greenDepth: 37, tee: { lat: 28.913252, lon: -81.999551 }, green: { lat: 28.912943, lon: -82.002888 }, overlay: { A: { x: 0.4808, y: 0.722 }, B: { x: 0.4597, y: 0.3898 }, C: { x: 0.5013, y: 0.0869 } } },
      ...
      { hole: 4, par: 4, hcp: 1, greenDepth: 33, tee: { lat: 28.919611, lon: -82.005384 }, green: { lat: 28.919501, lon: -82.008325 }, overlay: { A: { x: 0.4929, y: 0.7155 }, B: { x: 0.4955, y: 0.3377 }, C: { x: 0.5013, y: 0.0901 } } },
      { hole: 5, par: 3, hcp: 7, greenDepth: 31, tee: { lat: 28.919678, lon: -82.009969 }, green: { lat: 28.918738, lon: -82.010008 }, overlay: { A: { x: 0.5493, y: 0.6059 }, B: { x: 0.4982, y: 0.0858 }, C: { x: 0.4987, y: 0.0858 } } },
      { hole: 6, par: 4, hcp: 6, greenDepth: 41, tee: { lat: 28.918542, lon: -82.007861 }, green: { lat: 28.918776, lon: -82.004854 }, overlay: { A: { x: 0.4966, y: 0.722 }, B: { x: 0.4755, y: 0.3692 }, C: { x: 0.4992, y: 0.0814 } } },
      { hole: 7, par: 4, hcp: 9, greenDepth: 33, tee: { lat: 28.919259, lon: -82.003497 }, green: { lat: 28.918685, lon: -82.000894 }, overlay: { A: { x: 0.4924, y: 0.6916 }, B: { x: 0.4929, y: 0.3192 }, C: { x: 0.5003, y: 0.0879 } } },
    ...
    LaurelValley: [
      { hole: 1, par: 4, hcp: 5, greenDepth: 31, tee: { lat: 28.914094, lon: -81.993033 }, green: { lat: 28.911572, lon: -81.993309 }, overlay: { A: { x: 0.5024, y: 0.6927 }, B: { x: 0.5467, y: 0.3909 }, C: { x: 0.4992, y: 0.0901 } } },
      { hole: 2, par: 5, hcp: 6, greenDepth: 40, tee: { lat: 28.914904, lon: -81.99415 }, green: { lat: 28.918521, lon: -81.993153 }, overlay: { A: { x: 0.4976, y: 0.7807 }, B: { x: 0.4692, y: 0.4669 }, C: { x: 0.4987, y: 0.0901 } } },
      { hole: 3, par: 4, hcp: 1, greenDepth: 42, tee: { lat: 28.919511, lon: -81.993516 }, green: { lat: 28.921602, lon: -81.995307 }, overlay: { A: { x: 0.4939, y: 0.7296 }, B: { x: 0.5213, y: 0.3312 }, C: { x: 0.5008, y: 0.089 } } },
      ...
      { hole: 7, par: 4, hcp: 2, greenDepth: 41, tee: { lat: 28.9204, lon: -81.992783 }, green: { lat: 28.919149, lon: -81.990133 }, overlay: { A: { x: 0.5045, y: 0.7166 }, B: { x: 0.5366, y: 0.354 }, C: { x: 0.4992, y: 0.0901 } } },
      ...
      { hole: 9, par: 4, hcp: 4, greenDepth: 41, tee: { lat: 28.917349, lon: -81.99269 }, green: { lat: 28.914723, lon: -81.993205 }, overlay: { A: { x: 0.5045, y: 0.7296 }, B: { x: 0.5356, y: 0.4463 }, C: { x: 0.4982, y: 0.089 } } },
    ],

    RileyGrove: [
      { hole: 1, par: 4, hcp: 7, greenDepth: 32, tee: { lat: 28.910095, lon: -81.989156 }, green: { lat: 28.91215, lon: -81.987983 }, overlay: { A: { x: 0.4997, y: 0.6471 }, B: { x: 0.4744, y: 0.3692 }, C: { x: 0.4992, y: 0.0869 } } },
      ...
      { hole: 3, par: 4, hcp: 9, greenDepth: 32, tee: { lat: 28.917976, lon: -81.98363 }, green: { lat: 28.919317, lon: -81.985533 }, overlay: { A: { x: 0.504, y: 0.6059 }, B: { x: 0.4665, y: 0.2845 }, C: { x: 0.4992, y: 0.0825 } } },
      { hole: 4, par: 5, hcp: 4, greenDepth: 31, tee: { lat: 28.919516, lon: -81.98411 }, green: { lat: 28.919281, lon: -81.979933 }, overlay: { A: { x: 0.5018, y: 0.7546 }, B: { x: 0.5203, y: 0.4495 }, C: { x: 0.4987, y: 0.0879 } } },
      { hole: 5, par: 4, hcp: 1, greenDepth: 34, tee: { lat: 28.918801, lon: -81.978643 }, green: { lat: 28.919187, lon: -81.975673 }, overlay: { A: { x: 0.4992, y: 0.7155 }, B: { x: 0.4855, y: 0.3203 }, C: { x: 0.4997, y: 0.0858 } } },
      ...
      { hole: 7, par: 4, hcp: 3, greenDepth: 30, tee: { lat: 28.915833, lon: -81.976434 }, green: { lat: 28.913682, lon: -81.97516 }, overlay: { A: { x: 0.4982, y: 0.6721 }, B: { x: 0.5482, y: 0.38 }, C: { x: 0.5008, y: 0.0825 } } },
      ...
      { hole: 9, par: 5, hcp: 5, greenDepth: 32, tee: { lat: 28.911511, lon: -81.980021 }, green: { lat: 28.909728, lon: -81.983721 }, overlay: { A: { x: 0.504, y: 0.7687 }, B: { x: 0.524, y: 0.3855 }, C: { x: 0.4992, y: 0.0836 } } },
    ],
  },
};
